...
class Courseinfo(models.Model):
    """课程信息"""
    course_org = models.ForeignKey(Organizationinfo, on_delete=models.SET_NULL, null=True, verbose_name='所属机构')
    teacher = models.ForeignKey(Teacher, on_delete=models.SET_NULL, null=True, verbose_name='讲师')
...
class Video(models.Model):
    ...
    # 播放地址
    # 添加时间
    lession = models.ForeignKey(Lession, on_delete=models.SET_NULL, null=True, verbose_name='章节')
...
class CourseResource(models.Model):
    ...
    # 下载地址
    # 添加时间
    lession = models.ForeignKey(Courseinfo, on_delete=models.SET_NULL, null=True, verbose_name='课程')
