# Generated by Django 2.0.5 on 2018-06-02 06:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('lession', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='courses.Lession', verbose_name='章节')),
            ],
            options={
                'verbose_name': '视频',
