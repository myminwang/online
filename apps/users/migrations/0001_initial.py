    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='users/default.png', upload_to='users/%Y/%m', verbose_name='用户头像')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(max_length=200, upload_to='users/%Y/%m', verbose_name='轮播图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_delete', models.BooleanField(default=0, verbose_name='是否已验证')),
            ],
            options={
                'verbose_name': '邮箱验证信息',
