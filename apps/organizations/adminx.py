...
class OrganizationinfoAdmin:
    """机构信息管理"""
    list_display = ['category', 'city', 'name', 'images', 'students',
...
class TeacherAdmin:
    """讲师信息管理"""
    list_display = ['org', 'name', 'images', 'age', 'work_years', 'work_position',
                    'teach_points', 'fav_nums', 'add_time', 'click_nums']
    list_filter = ['org', 'name', 'images', 'age', 'work_years', 'work_position',
                   'teach_points', 'fav_nums', 'click_nums']
    search_fields = ['org', 'name', 'images', 'age', 'work_years', 'work_position',
                     'teach_points', 'fav_nums', 'add_time', 'click_nums']
