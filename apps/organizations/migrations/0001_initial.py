    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default=100, upload_to='orgs/%Y/%m', verbose_name='机构logo')),
                ...
                ('city', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='organizations.City', verbose_name='所在城市')),
            ],
            options={
                'verbose_name': '授课机构',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='teacher/default.png', upload_to='teachers/%Y/%m', verbose_name='教师头像')),
                ...
                ('add_time', models.DateField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('click_nums', models.IntegerField(default=0, verbose_name='点击数')),
                ('org', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='organizations.Organizationinfo', verbose_name='就职公司')),
            ],
            options={
                'verbose_name': '讲师',
